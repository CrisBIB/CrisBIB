...
<div style="display:flex; justify-content:space-evenly"><a href="https://youtu.be/LaGT7VlIF4o" target="_blank" style="text-align:center"><img src="./images/Video_SonGotlab.png" alt="youtube image" style="width:40%; margin-left:auto; margin-right:auto; display: block; width:100px"></a><a href="https://youtu.be/VIRC-KtpRVU" style="text-align:center" target="_blank"><img src="./images/Video_EdCamp.png" alt="youtube image" style="width:40%; margin-left:auto; margin-right:auto; display: block; width:100px"></a></div>
